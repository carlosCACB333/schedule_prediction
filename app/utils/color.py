...
def build_percentage_color(floor_color, ceil_color, shade_percentage):
    red = (floor_color & 0xFF0000) + int(
        shade_percentage * ((ceil_color & 0xFF0000) - (floor_color & 0xFF0000))
    ) & 0xFF0000
    green = (floor_color & 0x00FF00) + int(
        shade_percentage * ((ceil_color & 0x00FF00) - (floor_color & 0x00FF00))
    ) & 0x00FF00
    blue = (floor_color & 0x0000FF) + int(
        shade_percentage * ((ceil_color & 0x0000FF) - (floor_color & 0x0000FF))
    ) & 0x0000FF
